...
// Paramètres
 ...
 uniform float height_scale; // gestion clavier du facteur hauteur
...
//   
//   //Calcul du vecteur projection de view_dir sur le plan de la surface
//   vec2 projection = view_dir.xy / view_dir.z *(height * height_scale);
//   
//   if(parallax)
//    tex_coords = tex_coords - projection; //décalage des coordonnées de texture en fonction de la projection
//    
...
//   //vec3 diffuse = base_color; // Pour ne pas appliquer la gestion des normales 
//   // Specular    
