...
//    vec3 grad = vec3(1.0,1.0,1.0);
  ...
  //   grad.x = texelFetch(dataFieldTex, (int)(pos.x+1), 0).a - texelFetch(dataFieldTex, (int)(pos.x-1), 0).a ;
//   grad.y = texelFetch(dataFieldTex, (int)(pos.y+1), 0).a - texelFetch(dataFieldTex, (int)(pos.y-1), 0).a ;
//   grad.z = texelFetch(dataFieldTex, (int)(pos.z+1), 0).a - texelFetch(dataFieldTex, (int)(pos.z-1), 0).a ;

//   grad.x = pos.Sample(TrilinearClamp, uvw + vec3( d, 0, 0)) -
// 	  pos.Sample(TrilinearClamp, uvw + vec3(-d, 0, 0));
//   grad.y = pos.Sample(TrilinearClamp, uvw + vec3( 0, d, 0)) -
// 	  pos.Sample(TrilinearClamp, uvw + vec3( 0,-d, 0));
//   grad.z = pos.Sample(TrilinearClamp, uvw + vec3( 0, 0, d)) -
// 	  pos.Sample(TrilinearClamp, uvw + vec3( 0, 0,-d));
